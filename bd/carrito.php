...
<body>
    ...
    <main>
        ...
        if (!empty($_SESSION['carrito'])) {
            ...
            echo '<a class="botones-carrito" href="?action=actualizar_carrito"><button>Actualizar Carrito</button></a>';

            // Botón de vaciar carrito
            echo '<a class="botones-carrito" href="?action=vaciar_carrito"><button>Vaciar Carrito</button></a>';
            echo '</div>';
        } else {
            echo '<p class="carritoVacio">El carrito de compras está vacío.</p>';
        }
        ?>
    </main>
    <footer>
        <div class="row m-0">
            <div class="col-md-6 row m-0">
                <div class="col-6 d-flex justify-content-center">
                    <div>
                        <p style="font-weight: bold;">ÁREA PRIVADA</p>
                        <p><a href="login.html">Entrar</a></p>
                        <p><a href="register.html">Registrarme</a></p>
                    </div>
                </div>

                <div id="contact" class="col-6 d-flex justify-content-center">
                    <div>
                        <p style="font-weight: bold;">CONTACTO</p>
                        <p><a href="tel:956523521">956-52-35-21</a></p>
                        <p><a href="mailto:bioSalud@gmail.com">bioSalud@gmail.com</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 row m-0">
                <div class="col-6 d-flex justify-content-center">
                    <div>
                        <p style="font-weight: bold;">SOBRE NOSOTROS</p>
                        <p><a href="#">Nuestra Historia</a></p>
                        <p><a href="#">Sustentabilidad</a></p>
                    </div>
                </div>

                <div class="col-6 d-flex justify-content-center">
                    <div>
                        <p style="font-weight: bold;">AVISO LEGAL</p>
            ...
            <div class="col-md-6 d-flex justify-content-center">
                <div>
                    ...
                    <div class="redes-sociales">
                        <a href="#"><svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                <path
            ...
            <div class="col-md-6 align-self-end">
                <div class="d-flex justify-content-center">
                    <p>© 2024 BioSalud Inc. All Rights Reserved</p>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div id="google_translate_element" class="google text-end"></div>
            </div>
