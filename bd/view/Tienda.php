...
<main class="contenedor">
    ...
    if ($idCategoriaSeleccionada == 0) {
        ...
        echo '<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">';
        echo '<div class="carousel-inner">';
        echo ' <div class="carousel-item active">';
        echo ' <img src="../IMAGEN/bienvenido.png" class="d-block h-100" alt="...">';
        echo ' </div>';
        echo '<div class="carousel-item">';
        echo ' <img src="../IMAGEN/des.png" class="d-block h-100" alt="...">';
        echo ' </div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
